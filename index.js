...
function doSomething() {
    var d = new Date(),
        h = new Date(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours(), d.getMinutes() + 2, 0, 0),
        e = h - d;
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4) {
          console.log("Connected");
            ...
            str2 = str.slice(str.indexOf("<tr>")+4,str.lastIndexOf("</td>")+1);
            str2 = str2.slice(str2.indexOf("<tr>"))
            for (var i=0;i<10;i++) {
              x[i+1][0]=eval(x[i+1]);
              str3= str2.slice(str2.indexOf("<td>")+4,str2.indexOf("</tr>"));
              str3= str3.slice(str3.indexOf("<td>")+4,str3.indexOf("</td>"));
              x[i+1].push(str3);
              str2 = str2.slice(str2.indexOf("</tr")+5);
            }
